...
function WarzoneManager:switchToNextPhase(manualSwitch)
	...
	if(currentPhase == 2) then
		TheedManager.despawnSceneObjects(1)
		TheedManager.despawnSceneObjects(2)
		TheedManager.despawnSceneObjects(3)
		TheedManager:despawnMobiles(1)
		TheedManager:despawnMobiles(2)
		TheedManager:despawnMobiles(3)
